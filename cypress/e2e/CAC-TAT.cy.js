describe('Central de Atendimento ao Cliente TAT', () => {
  ...
  it('preenche os campos obrigatórios e envia o formulário', () => {
    ...
    const longText = Cypress._.repeat('Teste de preenchimento de campo obrigatório. ', 10)
  ...
  it('preenche a área de texto usando o comando invoke', () => {
    cy.get('#open-text-area').invoke('val', 'Colando um texto qualquer')
      .should('have.value', 'Colando um texto qualquer')
  })
